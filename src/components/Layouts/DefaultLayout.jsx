...
const Layout = () => {
    ...
    return (
        <div>
            <div className="flex flex-col min-h-screen text-base antialiased font-normal bg-white font-montserrat">
                <Navbar className={showTopButton ? "sticky-header" : ""} />
            ...
            {showTopButton && (
                <button
                    type="button"
                    className="fixed z-10 bottom-5 right-5 animate-bounce"
                    onClick={goToTop}>
